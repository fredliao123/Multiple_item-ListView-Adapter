...
public class ItemThree extends RelativeLayout implements ItemViewInterface<BaseBean> {
	...
	public ItemThree(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public ItemThree(Context context, AttributeSet attrs, int defStyle) {
	...
	public void buildView(Context context) {
		...
		View view = inflate(context, R.layout.layout_three, this);	
	}
