...
public class ItemTwo extends RelativeLayout implements ItemViewInterface<BaseBean> {
	...
	public ItemTwo(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public ItemTwo(Context context, AttributeSet attrs, int defStyle) {
	...
	public void buildView(Context context) {
		...
		View view = inflate(context, R.layout.layout_two, this);	
	}
